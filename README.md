...
Templatus is an opinionated template to build web applications with Ruby on Rails and Inertia (using Svelte). It simplifies the process of setting up a new application while following best practices.

Live demo available at https://templatus-inertia.ledermann.dev

There is a sister repository that uses Hotwire instead of Inertia:
https://github.com/ledermann/templatus-hotwire/

There is a sister repository that doesn't use Inertia and uses Vue.js instead of Svelte:
...
- [Inertia.js](https://inertiajs.com/) as a protocol for frontend/backend communication
...
- Gzip and Brotli compression of all dynamic responses (HTML, JSON) using [Rack::Deflater](https://github.com/rack/rack/blob/master/lib/rack/deflater.rb), [Rack::Brotli](https://github.com/marcotc/rack-brotli)
...
../../public/vite/assets/application.af5b711d.css   18.27 KiB / gzip: 4.45 KiB
../../public/vite/assets/application.bcf574e9.js    141.29 KiB / gzip: 48.42 KiB
../../public/vite/assets/application.bcf574e9.js.map 525.52 KiB
