...
>
  <div class="flex w-full items-end space-x-2 sm:w-auto">
    ...
    {#if git.commitTime && git.commitVersion}
      <GitVersion
        commitVersion={git.commitVersion}
        commitTime={git.commitTime}
      />
    {/if}
  </div>
  ...
  <div class="flex w-full items-end sm:w-auto">
    ...
    >
      <svg class="inline h-8 w-8" viewBox="0 0 276 276" fill="currentColor">
        <title>ledermann.dev</title>
        <path
          d="M0 137l138 138 138-138-84-82-84 82 31 30 53-52 25 22-79 77-78-77L166 29 138 1"
        />
      </svg><span class="ml-1 font-mono">ledermann.dev</span>
    </a>
  </div>
</footer>
